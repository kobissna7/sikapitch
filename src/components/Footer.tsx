        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p>
                Africa's premier startup pitch aggregator, connecting bold founders with the funding,
                mentorship, and platforms they need to build ventures that transform communities.
              </p>
            </div>
            ...
            <div className="footer-col">
              <h4>Get Started</h4>
              <Link to="/register">Register as Startup</Link>
              <Link to="/register?type=investor">Register as Investor</Link>
              <Link to="/login">Sign In</Link>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; {new Date().getFullYear()} SikaPitch. All rights reserved.</p>
